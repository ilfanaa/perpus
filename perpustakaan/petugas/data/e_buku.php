...
$query = "UPDATE buku SET judul='$judul',  foto='$foto', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', deskripsi='$deskripsi', buku='$buku' WHERE id_buku='$id_buku'";
