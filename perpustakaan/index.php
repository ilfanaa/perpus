       ...
       <div class="card bg-secondary-subtle" style="margin-top: 11rem;"> 
          <div class="row">
              ...
              <form action="aksi/cek_login1.php" method="post">
                  ...
                  <p class="mt-3">Saya belum memiliki akun. Buat <a href="registrasi.php" class="btn btn-warning text-white">Daftar Akun</a></p>
                  </div>
                  <div class="col">
                    <img src="assets/img/login.png" width="400" alt="">
              </div>
           </div>
        </div>
     </div>
