...
$query = "UPDATE buku SET id_kategori='$id_kategori', judul='$judul',  foto='$foto', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', deskripsi='$deskripsi', buku='$buku' WHERE id_buku='$id_buku'";
