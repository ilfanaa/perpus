...
$query = mysqli_query($koneksi, "SELECT peminjaman.id_peminjaman, peminjaman.id_buku, buku.judul,  buku.foto, buku.tahun_terbit, user.nama_lengkap, user.id_user, peminjaman.tanggal_peminjaman, peminjaman.tanggal_pengembalian, peminjaman.status_peminjaman
FROM peminjaman
        ...
        ?>
            <div class="card" style="width: 16rem;">
                ...
                <img src="../petugas/asset/sampul/<?php echo $d['foto']; ?>" class="card-img-top" alt="...">
                    ...
                    <form action="data/edit_status.php" method="POST">
                            <input type="hidden" class="form-control" name="id_peminjaman" value="<?= $d['id_peminjaman']; ?>">
                ...
                <a href="data/baca.php?id_buku=<?php echo $d['id_buku']; ?>" class="btn btn-success my-4">Baca Sekarang</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="/asset/sampul<?= $row['foto']; ?>" alt="" width="200">
                            </div>
                            <div class="col-md-8">
                                <form action="">
                                    <div class="row mb-3">
