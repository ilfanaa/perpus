      ...
      <div class="row m-4">
        ...
        <div class="col-sm-7">
          <form action="t_pinjam.php" method="POST">
            ...
            <input type="text" name="nama_peminjam" class="form-control" hidden id="exampleInputEmail1" aria-describedby="emailHelp">
            ...
            <input type="text" name="status_peminjaman" class="form-control" value="dipinjam" hidden id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
